...
class Exercise extends DataClass implements Insertable<Exercise> {
  ...
  final String title;
  final int category;
  Exercise({@required this.id, @required this.title, @required this.category});
  ...
  Exercise copyWith({int id, String title, int category}) => Exercise(
        id: id ?? this.id,
        title: title ?? this.title,
  ...
  @override
  int get hashCode =>
      $mrjf($mrjc(id.hashCode, $mrjc(title.hashCode, category.hashCode)));
  @override
  bool operator ==(dynamic other) =>
      identical(this, other) ||
      (other is Exercise &&
...
abstract class _$GymDatabase extends GeneratedDatabase {
  _$GymDatabase(QueryExecutor e) : super(SqlTypeSystem.defaultInstance, e);
  ...
  @override
  List<DatabaseSchemaEntity> get allSchemaEntities => [categories, exercises];
}
